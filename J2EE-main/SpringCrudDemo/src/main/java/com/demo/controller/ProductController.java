...
public class ProductController {
	...
	public ModelAndView insertProduct(@RequestParam int pid, @RequestParam String pname,@RequestParam int qty,@RequestParam int price) {
	...
	public ModelAndView updateProdut(@RequestParam int pid, @RequestParam String pname,@RequestParam int qty,@RequestParam int price) {
